...
class democontrollertabs extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Ali Importer');
        ...
        foreach (Language::getLanguages(true) as $lang) {
            $tabNames[$lang['locale']] = $this->trans('Ali Importer', [], 'Modules.Democontrollertabs.Admin', $lang['locale']);
        }
        $this->tabs = [
            [
                'route_name' => 'ps_controller_tabs_dashboard',
